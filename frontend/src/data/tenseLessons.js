...
const baseTenseLessons = [
  ...
  {
    id: 'future-forms', level: 'conversation', period: 'future', title: 'Future Forms',
    summary: 'Dos formas frecuentes de hablar del futuro: will y going to.',
    structure: 'Will: sujeto + will + verbo base\nGoing to: sujeto + am / is / are + going to + verbo base',
    rules: ['Will pertenece al Future Simple.', 'Going to habla del futuro, pero no corresponde al Future Simple.'],
    examples: [["I'll help you.", 'Te ayudaré.'], ["I'm going to study tonight.", 'Voy a estudiar esta noche.']],
    futureForms: {
      sections: [
        {
          id: 'will', label: 'Future Simple — Will', eyebrow: 'FUTURE SIMPLE',
          intro: 'Will se usa con todos los sujetos y siempre va seguido del verbo en su forma base.',
          structures: [
            ['Afirmativa', 'Subject + will + base verb', 'She will call later.'],
            ['Negativa', 'Subject + will not / won’t + base verb', 'She won’t call later.'],
            ['Interrogativa', 'Will + subject + base verb?', 'Will she call later?'],
            ['Respuesta corta', 'Yes, subject + will. / No, subject + won’t.', 'Yes, she will. / No, she won’t.'],
            ['Wh- questions', 'Wh-word + will + subject + base verb?', 'What will you do? · Where will she go?'],
          ],
          uses: [
            ['Decisión espontánea', "The phone is ringing. I’ll answer it.", 'La decisión se toma en ese momento.'],
            ['Promesa', 'I will help you tomorrow.', 'La persona se compromete a hacer algo.'],
            ['Ofrecimiento', 'I’ll carry that bag for you.', 'Will permite ofrecer ayuda.'],
            ['Predicción u opinión', 'I think it will rain tomorrow.', 'Es una opinión, no una evidencia visible.'],
          ],
        },
        {
          id: 'going-to', label: 'Going to', eyebrow: 'OTRA FORMA DE FUTURO',
          intro: 'Going to se utiliza para hablar del futuro, aunque gramaticalmente no corresponde al Future Simple. El verbo to be cambia según el sujeto.',
          structures: [
            ['Afirmativa', 'Subject + am/is/are + going to + base verb', 'They are going to travel.'],
            ['Negativa', 'Subject + am/is/are + not + going to + base verb', 'They aren’t going to travel.'],
            ['Interrogativa', 'Am/Is/Are + subject + going to + base verb?', 'Are they going to travel?'],
            ['Respuesta corta', 'Yes, subject + am/is/are. / No, subject + am/is/are not.', 'Yes, they are. / No, they aren’t.'],
          ],
          uses: [
            ['Plan o intención', "I’m going to study tonight.", 'La decisión ya estaba tomada.'],
            ['Evidencia presente', "Look at those clouds! It’s going to rain.", 'La predicción se basa en algo que podemos observar ahora.'],
          ],
        },
        {
          id: 'compare', label: 'Will vs. Going to', eyebrow: 'COMPARACIÓN',
          intro: 'Ambas estructuras hablan del futuro. La diferencia principal está en cómo se toma la decisión o en qué se basa la predicción.',
          comparisons: [
            ["I’ll answer the phone.", 'Will', 'Decisión espontánea tomada ahora.'],
            ["I’m going to study tonight.", 'Going to', 'Plan decidido previamente.'],
            ['I think it will rain tomorrow.', 'Will', 'Predicción basada en una opinión.'],
            ["Look at those clouds! It’s going to rain.", 'Going to', 'Predicción basada en evidencia presente.'],
          ],
          quickRule: 'Decisión ahora u opinión → will. Plan previo o evidencia visible → going to.',
        },
      ],
    },
    questions: [
      { kind: 'will', prompt: 'Completa: I ___ call you later.', answers: ['will'], explanation: 'La afirmativa usa will + verbo base.' },
      { kind: 'will', prompt: 'Completa: She ___ help us tomorrow.', answers: ['will'], explanation: 'Will no cambia con she y va seguido del verbo base help.' },
      { kind: 'will', prompt: 'Completa: They ___ arrive soon.', answers: ['will'], explanation: 'La afirmativa usa subject + will + base verb.' },
      { kind: 'will', prompt: 'Completa: He ___ not attend the event.', answers: ['will'], explanation: 'La negativa completa es He will not attend the event.' },
      { kind: 'will', prompt: 'Completa en negativa: We ___ be late.', answers: ["won't", 'will not'], explanation: 'La negativa usa won’t o will not + verbo base.' },
      { kind: 'will', prompt: 'Transforma a negativa: She will call tonight.', answers: ['She will not call tonight', "She won't call tonight"], explanation: 'Agregamos not después de will; call permanece en forma base.' },
      { kind: 'will', prompt: 'Formula la pregunta: ¿Me ayudarás?', answers: ['Will you help me'], explanation: 'La pregunta comienza con will y mantiene help en su forma base.' },
      { kind: 'will', prompt: 'Formula la pregunta: ¿Ella vendrá mañana?', answers: ['Will she come tomorrow'], explanation: 'Usamos Will + she + verbo base come.' },
      { kind: 'will', prompt: 'Completa la respuesta corta: Will he come? Yes, he ___.', answers: ['will'], explanation: 'La respuesta corta afirmativa es Yes, he will.' },
      { kind: 'will', prompt: 'Completa la respuesta corta: Will they wait? No, they ___.', answers: ["won't", 'will not'], explanation: 'La respuesta corta negativa es No, they won’t.' },
      { kind: 'will', prompt: 'Traduce: Te llamaré esta noche.', answers: ['I will call you tonight', "I'll call you tonight"], explanation: 'Usamos will + call para expresar la acción futura.' },
      { kind: 'will', prompt: 'Traduce: No olvidaremos tu ayuda.', answers: ['We will not forget your help', "We won't forget your help"], explanation: 'La negativa usa will not o won’t + forget.' },
    ],
  },
  {
...
export const tenseLessons = baseTenseLessons.map((lesson) => ({
  ...
  questions: [...lesson.questions, ...(extraTenseQuestions[lesson.id] ?? [])].map((question, index) => ({
    ...
    ...(lesson.id === 'future-forms' ? { practiceGroup: index < 12 ? 'part-1' : 'part-2' } : {}),
    ...(['present-simple', 'past-simple'].includes(lesson.id) ? {
      practiceGroup: question.kind === 'be' ? 'be' : index < 12 ? 'action-1' : 'action-2',
    } : {}),
